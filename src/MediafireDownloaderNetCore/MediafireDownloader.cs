...
public class MediafireDownloader
{
    ...
    /// <returns></returns>
    private static IEnumerable<string> GetHrefs(string url)
    {
    ...
    public static void DownloadMediafireFileAsync(string url, string destFilename, WebClient webClient = null,
        bool webClientDenugging = false)
    {
        AssignDownloadInfo(url, destFilename, webClient, webClientDenugging)
            .DownloadFileAsync(new Uri(GetMediafireDDL(url)), destFilename);
    }
    ...
    private static WebClient AssignDownloadInfo(string url, string destFilename, WebClient webClient,
        bool webClientDenugging = false)
    {
        _downloadingUrl = url;
